...
h = a % b   #modulo
print("le resultat de " + str(a) + " + " + str(b) + " est " + str(c))
print("le resultat de " + str(a) + " * " + str(b) + " est " + str(d))
print("le resultat de " + str(a) + " exposant " + str(b) + " est " + str(e))
print("le resultat de " + str(a) + " / " + str(b) + " est " + str(f))
print("le resultat de la division entiere de " + str(a) + " par " + str(b) + " est " + str(g))
print("le resultat de " + str(a) + " modulo " + str(b) + " est " + str(h))
...
#suppression de de h du dictionnaire
del mon_dict["modulo"]
